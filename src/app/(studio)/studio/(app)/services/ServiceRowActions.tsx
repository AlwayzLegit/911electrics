...
import { deleteService } from '@/app/actions/studio-services'

export function ServiceRowActions({ id, slug }: { id: number; slug: string | null }) {
      ...
      <button
        ...
        onClick={() => {
          if (confirm('Delete this service? This cannot be undone.')) {
            startTransition(() => deleteService(id, slug ?? ''))
          }
        }}
        type="button"
      >
